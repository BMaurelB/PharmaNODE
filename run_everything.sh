...
do
    ...
    python3 $GENERATE_DATA --exp $EXPERIMENT_ID --num_patients $NUM_PATIENTS --first_at $FIRST_AT
    # --- Step 1: Train the model ---
    echo "Training model..."
    Rscript $BASE_COMMAND_R --virtual_cohort virtual_cohort_test.csv --output_dir exp_run_all/$EXPERIMENT_ID --cores 10
