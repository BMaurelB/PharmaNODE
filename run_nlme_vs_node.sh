...
START_SEED=1
END_SEED=101 # Run for seeds from 1 to 10

# Define your Python script names
GENERATE_DATA='gen_tacro.py'
R_SCRIPT_TEST='run_tacro_analysis.R'
...
BASE_COMMAND_R="$R_SCRIPT_TEST --virtual_cohort virtual_cohort_test.csv"
...
ALL_TEST_RESULTS_FILE="test_gen_tacro_1709.txt"
